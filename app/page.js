...
function BrowsePageInner() {
  ...
  return (
    <div>
      ...
      <div style={{ background: 'var(--oxblood)', borderRadius: 16, padding: 24, marginBottom: 16, display: 'flex', gap: 20, alignItems: 'center', flexWrap: 'wrap' }}>
        <div style={{ flex: 1, minWidth: 200 }}>
          <div className="serif" style={{ fontSize: 24, fontWeight: 500, color: 'var(--oxblood-bg)', marginBottom: 6, lineHeight: 1.15 }}>
            Your closet,<br />everyone's closet
          </div>
          <div style={{ fontSize: 13, color: '#F5C4B3', marginBottom: 14 }}>
            Rent or buy real pieces from real students near you
          </div>
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            <a href="#browse-results" style={{ background: 'var(--mustard-bg)', color: 'var(--mustard-ink)', fontSize: 12.5, fontWeight: 500, padding: '7px 14px', borderRadius: 999, textDecoration: 'none' }}>
              Browse looks
            </a>
            <button onClick={() => router.push('/listings/new')} style={{ background: 'rgba(250,238,218,0.16)', color: 'var(--oxblood-bg)', fontSize: 12.5, fontWeight: 500, padding: '7px 14px', borderRadius: 999, border: '1px solid rgba(250,238,218,0.4)' }}>
              List an item
            </button>
          </div>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6, width: 120, flexShrink: 0 }}>
          <div style={{ background: '#F0997B', borderRadius: 8, aspectRatio: '1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>👗</div>
          <div style={{ background: 'var(--mustard-bg)', borderRadius: 8, aspectRatio: '1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>👠</div>
          <div style={{ background: '#F5C4B3', borderRadius: 8, aspectRatio: '1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>👚</div>
          <div style={{ background: 'var(--oxblood-bg)', borderRadius: 8, aspectRatio: '1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>🧥</div>
        </div>
      </div>

      <div style={{ background: 'var(--mustard-bg)', borderRadius: 14, padding: 16, marginBottom: 24, display: 'flex', gap: 10 }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 20, overflowX: 'auto', paddingBottom: 2 }}>
        {['Dress', 'Outerwear', 'Shoes', 'Suit', 'Bag / Accessory'].map((c, i) => {
          const active = categories.includes(c);
          const palette = [
            { bg: 'var(--oxblood-bg)', ink: 'var(--oxblood-ink)' },
            { bg: 'var(--sage-bg)', ink: 'var(--sage-ink)' },
            { bg: '#E1F5EE', ink: '#04342C' },
            { bg: 'var(--mustard-bg)', ink: 'var(--mustard-ink)' },
            { bg: '#EEEDFE', ink: '#26215C' },
          ][i];
          return (
            <button
              key={c}
              ...
              style={{
                background: active ? palette.bg : 'var(--white)',
                color: active ? palette.ink : 'var(--ink-soft)',
                border: active ? 'none' : '1px solid var(--line)',
                fontSize: 13, fontWeight: 500, padding: '7px 16px', borderRadius: 999, whiteSpace: 'nowrap', flexShrink: 0,
              }}
            >
              {c}
            </button>
      ...
      <div id="browse-results" style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10, marginBottom: 16 }}>
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 500 }}>Browse</h1>
