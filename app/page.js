...
function BrowsePageInner() {
  ...
  return (
    <div>
      ...
      <div style={{ background: 'var(--oxblood)', borderRadius: 16, padding: '28px 24px', marginBottom: 24 }}>
        <div className="serif" style={{ fontSize: 26, fontWeight: 500, color: 'var(--oxblood-bg)', marginBottom: 6 }}>
          Your closet, everyone's closet
        </div>
        <div style={{ fontSize: 14, color: '#F5C4B3', marginBottom: 16 }}>
          Rent or buy real pieces from real students near you
        </div>
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <a href="#browse-results" style={{ background: 'var(--mustard-bg)', color: 'var(--mustard-ink)', fontSize: 13, fontWeight: 500, padding: '8px 16px', borderRadius: 999, textDecoration: 'none' }}>
            Browse looks
          </a>
          <button onClick={() => router.push('/listings/new')} style={{ background: 'rgba(250,238,218,0.16)', color: 'var(--oxblood-bg)', fontSize: 13, fontWeight: 500, padding: '8px 16px', borderRadius: 999, border: '1px solid rgba(250,238,218,0.4)' }}>
            List an item
          </button>
        </div>
      </div>
