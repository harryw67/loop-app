...
const STAGE_LABEL = { inquiry: 'Inquiry', pending: 'Pending', booked: 'Booked', out: 'With renter', return: 'Return', settled: 'Settled', declined: 'Declined', disputed: 'Disputed', no_show: 'No-show', expired: 'Expired' };
