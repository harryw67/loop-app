...
export default function NewListingPage() {
  ...
  const [form, setForm] = useState({ name: '', category: 'Dress', size: 'S', color: 'Black', gender: "Women's", price: '', deposit: '', description: '', care_instructions: '', min_days: '1', max_days: '14', rentable: true, purchasable: false, buy_price: '' });
