...
export async function PATCH(req, { params }) {
  ...
  const { name, category, size, color, gender, price, deposit, description, photos, distance, care_instructions, lat, lng, min_days, max_days, rentable, purchasable, buy_price } = body;
