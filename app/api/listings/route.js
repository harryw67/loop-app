...
export async function POST(req) {
  ...
  const { name, category, size, color, gender, price, deposit, description, photos, care_instructions, lat, lng, min_days, max_days, rentable, purchasable, buy_price } = body;
